...
namespace TuneOrBuy.Web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        private readonly SignInManager<Buyer> _signInManager;
        private readonly UserManager<Buyer> _userManager;
        private readonly IUserStore<Buyer> _userStore;
        private readonly IUserEmailStore<Buyer> _emailStore;
        private readonly ILogger<RegisterModel> _logger;
        private readonly IEmailSender _emailSender;

        public RegisterModel(
            UserManager<Buyer> userManager,
            IUserStore<Buyer> userStore,
        ...
        private IUserEmailStore<Buyer> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<Buyer>)_userStore;
        }
    }
}
